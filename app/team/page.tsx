...
const teamMembers = [
  {
    ...
    role: 'Founder & Lead',
    image: '/Naitik.jpg',
    bio: 'Naitik Kumar is the Founder of Tech4Hack, with experience working at IIT Delhi, IIT Bombay, IIT BHU, Deloitte, PW, and MyGov. He focuses on building impactful tech projects, workshops, and AI-driven solutions, leading Tech4Hack with the mission to make technology learning simple, practical, and accessible for students.',
  ...
  },
  {
    ...
    image: '/Yash.jpg',
    bio: 'Co-founder and Lead of Tech4hack.Work to create a strong tech community where students can learn, grow, and build together. Focus is on organising hackathons, workshops, and real project-based events that help students get practical skills',
  ...
  },
  {
    ...
    role: 'Technical Head',
    image: '/Avinash.jpg',
    bio: 'A dedicated full-stack developer with a strong enthusiasm for modern technology. Experienced in the MERN stack and Next.js, focused on building robust, scalable web applications and contributing innovative technical solutions to every project.',
  ...
  },
  {
    ...
    image: '/Lamiya.jpg',
    bio: '3rd-year B.Tech Computer Science student at MIET, Meerut. Passionate about cybersecurity, focusing on network security, ethical hacking, and data protection. Building skills through hands-on labs and learning. Seeking opportunities in cybersecurity to create safer digital environments. Open to connecting with professionals and peers',
